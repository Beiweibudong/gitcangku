!function (t, e) {
    ...
    return function (t) {
        ...
        }, O = Object.prototype.toString, z = Array.prototype, E = z.forEach, R = z.filter, N = z.slice, V = z.map, B = z.reduce, G = {
            inherits: h,
            mixin: c,
            clone: i,
            merge: n,
         ...
         */
        var w = i(10), S = i(125), M = i(93), I = i(23), T = i(126), A = i(13), L = i(16), C = i(59), D = i(28), P = i(3), k = i(6), O = i(47), z = i(78), E = i(1), R = i(19), N = i(21), V = i(46), B = E.each, G = A.parseClassType, F = 1e3, H = 5e3, W = 1e3, Z = 2e3, q = 3e3, j = 4e3, U = 5e3, X = "__flagInMainProcess", Y = "__hasGradientOrPatternBg", $ = "__optionUpdated", Q = /^[a-zA-Z0-9_]+$/;
        ...
        var et = [], it = {}, nt = [], ot = [], rt = [], at = {}, st = {}, lt = {}, ut = {}, ht = new Date - 0, ct = new Date - 0, dt = "_echarts_instance_", ft = {
            version: "3.4.0",
        ...
        function g(t, e, i, n, o, r) {
            ...
            if (a) {
                var s = t ? "Update" : "", l = n.getShallow("animationDuration" + s), u = n.getShallow("animationEasing" + s), h = n.getShallow("animationDelay" + s);
        ...
        S.Group = i(34), S.Image = i(49), S.Text = i(76), S.Circle = i(160), S.Sector = i(166), S.Ring = i(165), S.Polygon = i(162), S.Polyline = i(163), S.Rect = i(164), S.Line = i(161), S.BezierCurve = i(159), S.Arc = i(158), S.CompoundPath = i(153), S.LinearGradient = i(91), S.RadialGradient = i(154), S.BoundingRect = i(9), S.extendShape = function (t) {
            ...
            var n = e.getShallow("position") || "inside", o = e.getShallow("offset"), r = n.indexOf("inside") >= 0 ? "white" : i, a = e.getModel("textStyle");
            m.extend(t, {
        ...
        n.linearMap = function (t, e, i, n) {
            ...
            var i = Math.log, n = Math.LN10, o = Math.floor(i(t[1] - t[0]) / n), r = Math.round(i(Math.abs(e[1] - e[0])) / n), a = Math.min(Math.max(-o + r, 0), 20);
        ...
        a.formatTime = function (t, e) {
            ...
            var i = o.parseDate(e), n = i.getFullYear(), r = i.getMonth() + 1, a = i.getDate(), s = i.getHours(), l = i.getMinutes(), u = i.getSeconds();
        ...
        var o = i(1), r = i(9), a = i(4), s = i(8), l = a.parsePercent, u = o.each, h = {}, c = h.LOCATION_PARAMS = ["left", "right", "top", "bottom", "width", "height"];
        ...
        (function (e) {
            ...
            var r = "undefined", a = "undefined" == typeof window ? e : window, s = typeof a.Float64Array === r ? Array : a.Float64Array, l = typeof a.Int32Array === r ? Array : a.Int32Array, u = {
                ...
                number: Array,
                time: Array
            }, h = i(11), c = i(43), d = i(1), f = i(6), p = d.isObject, g = ["stackedOn", "hasItemOption", "_nameList", "_idList", "_rawData"], m = function (t, e) {
        ...
        "use strict";
        var n = i(1), o = i(8), r = i(15), a = i(6), s = i(13), l = i(57), u = i(10), h = i(12), c = r.set, d = r.get, f = o.encodeHTML, p = o.addCommas, g = s.extend({
            ...
            formatTooltip: function (t, e, i) {
                ...
                var a = d(this, "data"), s = this.getRawValue(t), l = f(n.isArray(s) ? r(s) : p(s)), u = a.getName(t), h = a.getItemVisual(t, "color");
        ...
        function s(t, e, i, o, r, a) {
            ...
            if (n(c) && n(d))if (n(l)) a[0] = 0; else {
                ...
                if (n(m)) {
                    ...
                    var T = (2 * c * l - 3 * s * d) / (2 * b(c * c * c)), A = Math.acos(T) / 3, L = b(c), C = Math.cos(A), g = (-l - 2 * L * C) / (3 * s), y = (-l + L * (C + M * Math.sin(A))) / (3 * s), D = (-l + L * (C - M * Math.sin(A))) / (3 * s);
        ...
        var v = i(5), y = v.create, x = v.distSquare, _ = Math.pow, b = Math.sqrt, w = 1e-8, S = 1e-4, M = b(3), I = 1 / 3, T = y(), A = y(), L = y();
        t.exports = {
            cubicAt: r,
            cubicDerivativeAt: a,
            cubicRootAt: s,
        ...
        u.getScaleExtent = function (t, e) {
            var i, n, o, r = t.scale, l = r.type, u = e.getMin(), h = e.getMax(), c = null != u, d = null != h, f = r.getExtent();
            ...
            var i = t.scale, n = u.getScaleExtent(t, e), o = null != e.getMin(), r = null != e.getMax(), a = e.get("splitNumber");
        ...
        "use strict";
        var n = i(18), o = i(5), r = i(75), a = i(9), s = i(33).devicePixelRatio, l = {
            M: 1,
            L: 2,
            C: 3,
            Q: 4,
                ...
                for (var e, i, n, o, r, a, s = this.data, u = this._ux, h = this._uy, c = this._len, d = 0; d < c;) {
                    ...
                    switch (1 == d && (n = s[d], o = s[d + 1], e = n, i = o), f) {
                        ...
                        case l.Q:
                            ...
                            break;
                        case l.A:
                            var p = s[d++], v = s[d++], x = s[d++], _ = s[d++], b = s[d++], w = s[d++], S = s[d++], M = s[d++], I = x > _ ? x : _, T = x > _ ? 1 : x / _, A = x > _ ? _ / x : 1, L = Math.abs(x - _) > .001, C = b + w;
        ...
        var n = i(4), o = i(8), r = i(32), a = Math.floor, s = Math.ceil, l = n.getPrecisionSafe, u = n.round, h = r.extend({
            type: "interval",
            _interval: 0,
        ...
        var r = i(1), a = i(10), s = i(2), l = i(6), u = i(68), h = i(182), c = r.each, d = u.eachAxisDim, f = s.extendComponentModel({
            type: "dataZoom",
        ...
        var s = i(1), l = i(8), u = i(3), h = i(11), c = i(4), d = c.remRadian, f = c.isRadianAroundZero, p = i(5), g = p.applyTransform, m = s.retrieve, v = Math.PI, y = function (t, e) {
        ...
        var x = {
            axisLine: function () {
                ...
                if (l && !r.isBlank()) {
                    var c = i.getModel("axisLabel"), d = c.getModel("textStyle"), f = c.get("margin"), p = r.scale.getTicks(), g = i.getFormattedLabels(), y = m(e.labelRotation, c.get("rotate")) || 0;
                    y = y * v / 180;
                    ...
                    if (s.each(p, function (t, o) {
                            if (!_(r, o, e.labelInterval)) {
                                ...
                                var s = a.getTextColor() || i.get("axisLine.lineStyle.color"), l = r.dataToCoord(t), c = [l, e.labelOffset + e.labelDirection * f], p = r.scale.getLabel(t), m = new u.Text({
                                    anid: "label_" + t,
                                    style: {
                                        text: g[o],
                ...
                if (i) {
                    ...
                    var w = f.getFont(), S = e.get("nameTruncate", !0) || {}, M = S.ellipsis, I = m(S.maxWidth, b), T = null != M && null != I ? l.truncateText(i, I, w, M, {
                            minChar: 2,
        ...
        var u = i(12), h = i(22), c = i(1), d = i(121), f = i(119), p = c.each, g = h.ifAxisCrossZero, m = h.niceScaleExtent;
        i(122);
        var v = r.prototype;
        ...
        var n = i(8), o = i(1), r = {}, a = ["x", "y", "z", "radius", "angle", "single"], s = ["cartesian2d", "polar", "singleAxis"];
        ...
        var o = i(6), r = i(1), a = i(10), s = i(8), l = s.addCommas, u = s.encodeHTML, h = i(2).extendComponentModel({
            ...
            formatTooltip: function (t) {
                var e = this.getData(), i = this.getRawValue(t), n = r.isArray(i) ? r.map(i, l).join(", ") : l(i), o = e.getName(t), a = u(this.name);
                ...
                if (!e.isSeriesFiltered(t)) {
                    ...
                    r.each(function (t) {
                        ...
                        if (s) n.setItemVisual(e, "color", s); else {
                            var l = n.getItemModel(e), u = l.get("itemStyle.normal.color") || t.getColorFromPalette(n.getName(e), i);
        ...
        var n = i(5), o = i(18), r = {}, a = Math.min, s = Math.max, l = Math.sin, u = Math.cos, h = n.create(), c = n.create(), d = n.create(), f = 2 * Math.PI;
        ...
        s.prototype = {
            constructor: s, drawRectText: function (t, e, i) {
                ...
                if (null != s && (s += ""), s) {
                    t.save();
                    var l, u, h = r.textPosition, c = r.textOffset, d = r.textDistance, f = r.textAlign, p = r.textFont || r.font, g = r.textBaseline, m = r.textVerticalAlign;
         ...
         */
        var o = i(64), r = i(10), a = i(1), s = i(140), l = i(143), u = i(144), h = i(152), c = !r.canvasSupported, d = {canvas: i(142)}, f = {}, p = {};
        ...
        var u = i(24), h = i(5), c = i(177), d = i(3), f = i(1), p = i(4), g = ["fromSymbol", "toSymbol"], m = l.prototype;
        ...
        var h = i(28).extend({
            type: "pie", init: function () {
                ...
                if (!o || o.from !== this.uid) {
                    var a = t.getData(), s = this._data, u = this.group, h = e.get("animation"), c = !s, d = t.get("animationType"), f = l.curry(n, this.uid, t, h, i), p = t.get("selectedMode");
                    if (a.diff(s).add(function (t) {
                        ...
                        var g = a.getItemLayout(0), m = Math.max(i.getWidth(), i.getHeight()) / 2, v = l.bind(u.removeClipPath, u);
        ...
        t.exports = function (t, e, i, u) {
            e.eachSeriesByType(t, function (t) {
                ...
                var h = i.getWidth(), c = i.getHeight(), d = Math.min(h, c), f = o(e[0], h), p = o(e[1], c), g = o(u[0], d / 2), m = o(u[1], d / 2), v = t.getData(), y = -t.get("startAngle") * l, x = t.get("minAngle") * l, _ = v.getSum("value"), b = Math.PI / (_ || v.count()) * 2, w = t.get("clockwise"), S = t.get("roseType"), M = t.get("stillShowZeroSum"), I = v.getDataExtent("value");
                I[0] = 0;
        ...
        var o = i(1), r = i(3), a = i(51), s = a.ifIgnoreOnTick, l = a.getInterval, u = ["axisLine", "axisLabel", "axisTick", "axisName"], h = ["splitArea", "splitLine"], c = i(2).extendComponentView({
            ...
            _splitArea: function (t, e, i) {
                var n = t.axis;
                if (!n.isBlank()) {
                    var a = t.getModel("splitArea"), u = a.getModel("areaStyle"), h = u.get("color"), c = e.coordinateSystem.getRect(), d = n.getTicksCoords(), f = n.scale.getTicks(), p = n.toGlobalCoord(d[0]), g = n.toGlobalCoord(d[0]), m = 0, v = l(a, i), y = u.getAreaStyle();
                    h = o.isArray(h) ? h : [h];
        ...
        var N = i(21), V = i(1), B = i(9), G = i(3), F = i(117), H = i(43), W = V.curry, Z = V.each, q = V.map, j = Math.min, U = Math.max, X = Math.pow, Y = 1e4, $ = 6, Q = 6, K = "globalPan", J = {
            w: [0, 0],
            e: [0, 1],
            n: [1, 0],
            s: [1, 1]
        ...
        var h = i(1), c = i(6), d = i(11), f = h.each, p = h.filter, g = h.map, m = h.isArray, v = h.indexOf, y = h.isObject, x = i(13), _ = i(127), b = "\0_ec_inner", w = d.extend({
        ...
        var a = i(1), s = i(134), l = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]], u = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"], h = ["bar", "boxplot", "candlestick", "chord", "effectScatter", "funnel", "gauge", "lines", "graph", "heatmap", "line", "map", "parallel", "pie", "radar", "sankey", "scatter", "treemap"], c = a.each;
        t.exports = function (t) {
        ...
        var n = i(1), o = i(4), r = i(8), a = i(38), s = a.prototype, l = Math.ceil, u = Math.floor, h = 1e3, c = 60 * h, d = 60 * c, f = 24 * d, p = function (t, e, i, n) {
            for (; i < n;) {
                var o = i + n >>> 1;
                t[o][2] < e ? i = o + 1 : n = o
            }
            ...
            for (var h = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (b === u.M && _ > 1 && (i || (h += m(p, g, y, x, o, l))), 1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
                    ...
                    case u.Q:
                        ...
                        break;
                    case u.A:
                        var w = t[_++], S = t[_++], M = t[_++], I = t[_++], T = t[_++], A = t[_++], L = (t[_++], 1 - t[_++]), C = Math.cos(T) * M + w, D = Math.sin(T) * I + S;
        ...
        var u = i(29).CMD, h = i(88), c = i(148), d = i(89), f = i(147), p = i(63).normalizeRadian, g = i(18), m = i(90), v = h.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        var u = i(25), h = i(1), c = i(21), d = i(10), f = i(150), p = u.addEventListener, g = u.removeEventListener, m = u.normalizeEvent, v = 300, y = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"], x = ["touchstart", "touchend", "touchmove"], _ = {
            pointerdown: 1,
            pointerup: 1,
            pointermove: 1,
            pointerout: 1
        ...
        var o = i(18), r = i(5), a = o.quadraticSubdivide, s = o.cubicSubdivide, l = o.quadraticAt, u = o.cubicAt, h = o.quadraticDerivativeAt, c = o.cubicDerivativeAt, d = [];
        t.exports = i(7).extend({
            type: "bezier-curve",
        ...
        var n = i(10), o = i(7), r = [["shadowBlur", 0], ["shadowColor", "#000"], ["shadowOffsetX", 0], ["shadowOffsetY", 0]];
        t.exports = o.extend({
            type: "sector",
        ...
        function n(t, e, i, n, o, r, a, s, l, u, h) {
            ...
            _ > 1 && (a *= c(_), s *= c(_));
            var b = (o === r ? -1 : 1) * c((a * a * (s * s) - a * a * (x * x) - s * s * (y * y)) / (a * a * (x * x) + s * s * (y * y))) || 0, w = b * a * x / s, S = b * -s * y / a, M = (t + i) / 2 + f(g) * w - d(g) * S, I = (e + n) / 2 + d(g) * w + f(g) * S, T = v([1, 0], [(y - w) / a, (x - S) / s]), A = [(y - w) / a, (x - S) / s], L = [(-1 * y - w) / a, (-1 * x - S) / s], C = v(A, L);
        ...
        var a = i(7), s = i(29), l = i(170), u = i(20), h = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"], c = Math.sqrt, d = Math.sin, f = Math.cos, p = Math.PI, g = function (t) {
        ...
        c.prototype = {
            constructor: c, hostedBy: function (t) {
                ...
                var e = this._dataExtent, i = this.getAxisModel(), n = i.axis.scale, r = [0, 100], a = [t.start, t.end], l = [];
        ...
        var o = i(41), r = i(1), a = i(85), s = i(189), l = r.bind, u = o.extend({
            ...
            _onZoom: function (t, e, i, o, r, a) {
                ...
                if (u) {
                    var c = h[e](null, [r, a], u, i, t), d = (c.pixel - c.pixelStart) / c.pixelLength * (l[1] - l[0]) + l[0];
        ...
        var o = i(1), r = i(3), a = i(47), s = i(41), l = r.Rect, u = i(4), h = u.linearMap, c = i(12), d = i(85), f = u.asc, p = o.bind, g = o.each, m = 7, v = 1, y = 30, x = "horizontal", _ = "vertical", b = 5, w = ["line", "bar", "candlestick", "scatter"], S = s.extend({
            type: "dataZoom.slider",
            init: function (t, e) {
        ...
        var s = i(1), l = i(19), u = i(25), h = i(8), c = s.each, d = h.toCamelCase, f = i(10), p = ["", "-webkit-", "-moz-", "-o-"], g = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
        a.prototype = {
        ...
        i(2).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                if (n.from !== this.uid) {
                    var e = this._ecModel, r = n.seriesIndex, a = e.getSeriesByIndex(r), i = this._api, s = "axis" === this._tooltipModel.get("trigger");
                ...
                if (i)if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
                    var a = e.dataModel || o.getSeriesByIndex(e.seriesIndex), s = e.dataIndex, l = a.getData(), u = l.getItemModel(s);
                ...
                if (e.length) {
                    ...
                    if (f.dispatchAction({
                        ...
                        if (o) h(r || a.get("position"), i[0], i[1], a.get("confine"), this._tooltipContent, v, null, f); else {
                            var y = c[u].dataIndexInside, x = "time" === s.type ? s.scale.getLabel(n[l]) : e[u].getData().getName(y), _ = (x ? g.encodeHTML(x) + "<br />" : "") + p.map(e, function (t, e) {
        ...
        if (!i(10).canvasSupported) {
            var n = i(5), o = i(9), r = i(29).CMD, a = i(19), s = i(17), l = i(77), u = i(36), h = i(49), c = i(76), d = i(7), f = i(37), p = i(171), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos, x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", S = "progid:DXImageTransform.Microsoft", M = 21600, I = M / 2, T = 1e5, A = 1e3, L = function (t) {
                ...
                for (a = 0; a < t.length;) {
                    switch (o = t[a++], n = "", i = 0, o) {
                        ...
                        case d:
                            ...
                            a++;
                            var F = t[a++], H = z + y(V) * R, W = E + x(V) * N, S = z + y(B) * R, T = E + x(B) * N, Z = F ? " wa " : " at ";
            ...
            h.prototype.brushVML = function (t) {
                ...
                if (o) {
                    var u = n.x || 0, h = n.y || 0, c = n.width, d = n.height, f = n.sWidth, v = n.sHeight, y = n.sx || 0, x = n.sy || 0, M = f && v, I = this._vmlEl;
        ...
        a.prototype = {
            constructor: a, draw: function (t, e, i, a, s) {
                ...
                var m = ["itemStyle", "normal"], v = ["itemStyle", "emphasis"], y = ["label", "normal"], x = ["label", "emphasis"];
                u.each(d.regions, function (e) {
                    var i = new l.Group, o = new l.CompoundPath({shape: {paths: []}});
                    i.add(o);
                    var r, a = t.getRegionModel(e.name) || t, s = a.getModel(m), d = a.getModel(v), g = n(s, p), _ = n(d, p), b = a.getModel(y), w = a.getModel(x);
                    if (c) {
                    ...
                    var T = b.get("show"), A = w.get("show"), L = c && isNaN(c.get("value", r)), C = c && c.getItemLayout(r);
                    if (h || L && (T || A) || C && C.showLabel) {
                        var D = c ? r : e.name, P = t.getFormattedLabel(D, "normal"), k = t.getFormattedLabel(D, "emphasis"), O = new l.Text({
                            style: {
                                text: T ? P || e.name : "",
                                fill: M.getTextColor(),
                                textFont: M.getFont(),
        ...
        var n = i(2), o = i(1), r = i(10), a = i(246), s = i(73), l = i(174), u = s.mapVisual, h = i(6), c = s.eachVisual, d = i(4), f = o.isArray, p = o.each, g = d.asc, m = d.linearMap, v = o.noop, y = ["#f6efa6", "#d88273", "#bf444c"], x = n.extendComponentModel({
            type: "visualMap",
            dependencies: ["series"],
        ...
        function n(t, e, i, n) {
            var l = t.getItemLayout(e), u = i.get("symbolRepeat"), h = i.get("symbolClip"), c = i.get("symbolPosition") || "start", d = i.get("symbolRotate"), f = (d || 0) * Math.PI / 180 || 0, p = i.get("symbolPatternSize") || 2, g = i.isAnimationEnabled(), m = {
                dataIndex: e,
                layout: l,
                itemModel: i,
        ...
        function o(t, e, i, n, o) {
            var r = n.valueDim, a = t.get("symbolBoundingData"), s = n.coordSys.getOtherAxis(n.coordSys.getBaseAxis()), l = s.toGlobalCoord(s.dataToCoord(0)), u = o.boundingLength = null != a ? s.toGlobalCoord(s.dataToCoord(s.scale.parse(a))) - l : e ? n.coordSysExtent[r.index][1 - +(i[r.wh] <= 0)] - l : i[r.wh];
        ...
        function s(t, e, i, n, o, r, a, s, l, u, h, c) {
            ...
            if (n) {
                ...
                var _ = Math.max(g + 2 * y, 0), b = x ? 0 : 2 * y, w = L.isNumeric(n), S = w ? n : M((v + b) / _), T = v - S * g;
        ...
        function u(t, e, i, n) {
            ...
            var s = t.__pictorialBundle, u = i.symbolSize, h = i.valueLineWidth, c = i.pathPosition, d = e.valueDim, f = i.repeatTimes || 0, p = 0, g = u[e.valueDim.index] + h + 2 * i.symbolMargin;
            for (b(t, function (t) {
        ...
        function d(t, e, i, n) {
            if (i.symbolClip) {
                var o = t.__pictorialClipPath, r = I.extend({}, i.clipShape), a = e.valueDim, s = i.animationModel, l = i.dataIndex;
        ...
        function S(t, e, i) {
            var n = i.color, o = i.dataIndex, r = i.itemModel, a = r.getModel("itemStyle.normal").getItemStyle(["color"]), s = r.getModel("itemStyle.emphasis").getItemStyle();
            b(t, function (t) {
        ...
        var I = i(1), T = i(3), A = i(24), L = i(4), C = i(81), D = L.parsePercent, P = ["itemStyle", "normal", "borderWidth"], k = [{
            xy: "x",
            wh: "width",
            index: 0,
            posDesc: ["left", "right"]
            ...
            type: "pictorialBar", render: function (t, e, i) {
                var o = this.group, r = t.getData(), a = this._data, s = t.coordinateSystem, l = s.getBaseAxis(), u = !!l.isHorizontal(), h = s.grid.getRect(), c = {
                    ecSize: {
                        width: i.getWidth(),
                        height: i.getHeight()
                    },
        ...
        function n(t, e) {
            var i, n = t.getBaseAxis(), a = "category" === n.type ? n.getBandWidth() : (i = n.getExtent(), Math.abs(i[1] - i[0]) / e.count()), s = r(o(t.get("barMaxWidth"), a), a), l = r(o(t.get("barMinWidth"), 1), a), u = t.get("barWidth");
        ...
        t.exports = function (t) {
            t.eachSeriesByType("candlestick", function (t) {
                ...
                i.each(o, function () {
                    ...
                    var l = arguments, u = o.length, h = l[0], c = l[u], d = "horizontal" === r ? 0 : 1, f = 1 - d, p = l[1], g = l[2], m = l[3], v = l[4], y = Math.min(p, g), x = Math.max(p, g), _ = t(y), b = t(x), w = t(m), S = t(v), M = [[S, b], [w, _]], I = [];
        ...
        var n = i(14), o = i(1), r = i(6), a = i(11), s = i(8), l = i(230), u = i(2).extendSeriesModel({
            ...
            formatTooltip: function (t, e, i) {
                if ("edge" === i) {
                    var n = this.getData(), o = this.getDataParams(t, i), r = n.graph.getEdgeByIndex(t), a = n.getName(r.node1.dataIndex), l = n.getName(r.node2.dataIndex), h = [];
        ...
        var o = i(39), r = i(99), a = i(84), s = i(3), l = i(275), u = i(1), h = ["itemStyle", "normal", "opacity"], c = ["lineStyle", "normal", "opacity"];
        i(2).extendChartView({
        ...
        t.exports = function (t) {
            t.eachSeriesByType("lines", function (t) {
                var e = t.getData(), n = i(t.get("symbol")), o = i(t.get("symbolSize")), r = "lineStyle.normal.opacity".split(".");
                e.setVisual("fromSymbol", n && n[0]), e.setVisual("toSymbol", n && n[1]), e.setVisual("fromSymbolSize", o && o[0]), e.setVisual("toSymbolSize", o && o[1]), e.setVisual("opacity", t.get(r)), e.each(function (t) {
                    var n = e.getItemModel(t), o = i(n.getShallow("symbol", !0)), a = i(n.getShallow("symbolSize", !0)), s = n.get(r);
        ...
        var n = i(14), o = i(16), r = i(1), a = i(27), s = i(8), l = s.encodeHTML, u = s.addCommas, h = i(69), c = i(173), d = o.extend({
            type: "series.map",
            dependencies: ["geo"],
            layoutMode: "box",
            needsDrawMap: !1,
        ...
        var n = i(16), o = i(14), r = i(27), a = i(1), s = i(8).encodeHTML, l = n.extend({
            ...
            formatTooltip: function (t) {
                var e = this.getRawValue(t), i = this.coordinateSystem, n = i.getIndicatorAxes(), o = this.getData().getName(t);
        ...
        var n = i(27), o = i(16), r = i(14), a = i(1), s = i(8), l = s.encodeHTML, u = i(245), h = 2, c = o.extend({
            ...
            formatTooltip: function (t) {
                var e = this.getData(), i = t.length, n = e.get("time", t[0]), o = this.coordinateSystem, r = o.getAxis();
            ...
            t.exports = i(2).extendChartView({
                type: "themeRiver", init: function () {
                    ...
                    function u(e, i, s) {
                        ...
                        var S, M, I = h.getItemLayout(m[0]), T = h.getItemModel(m[v - 1]), A = T.getModel("label.normal"), L = A.get("margin");
                        if ("add" === e) {
                        ...
                        var D = T.getModel("itemStyle.emphasis"), P = T.getModel("itemStyle.normal"), k = A.getModel("textStyle");
                        M.setStyle({
                    ...
                    if (h.count()) {
                        var d = this.group, f = t.getLayerSeries(), p = h.getLayout("layoutInfo"), g = p.rect, m = p.boundaryGap;
        ...
        function o(t, e, i, n, o, l, u, h, c, d) {
            ...
            if (u) {
                var T = u.getLayout();
                if (T && T.isInView) {
                    var A = T.width, L = T.height, C = T.invisible, D = u.getRawIndex(), P = h && h.getRawIndex(), k = x("nodeGroup", m);
                    if (k) {
        ...
        var a = i(1), s = i(3), l = i(43), u = i(83), h = i(326), c = i(84), d = i(9), f = i(20), p = i(394), g = a.bind, m = s.Group, v = s.Rect, y = a.each, x = 3, _ = ["label", "normal"], b = ["label", "emphasis"], w = 10, S = 1, M = 2;
        t.exports = i(2).extendChartView({
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function (t) {
                var n = e.getWidth(), r = e.getHeight(), a = t.option, s = m.getLayoutRect(t.getBoxLayoutParams(), {
                    width: e.getWidth(),
                    height: e.getHeight()
                }), l = a.size || [], u = b(w(s.width, l[0]), n), h = b(w(s.height, l[1]), r), g = i && i.type, x = v.retrieveTargetInfo(i, t), _ = "treemapRender" === g || "treemapMove" === g ? i.rootRect : null, M = t.getViewRoot(), I = v.getPathToRoot(M);
                if ("treemapMove" !== g) {
        ...
        var p = i(1), g = i(4), m = i(12), v = i(83), y = i(9), v = i(83), x = Math.max, _ = Math.min, b = g.parsePercent, w = p.retrieve, S = p.each;
        t.exports = n
    }, function (t, e, i) {
        ...
        var o = i(1), r = i(51), a = i(115), s = i(3), l = ["axisLine", "axisLabel", "axisTick", "axisName"], u = i(2).extendComponentView({
            type: "parallelAxis",
            init: function (t, e) {
        ...
        var o = i(51), r = i(1), a = i(3), s = o.getInterval, l = o.ifIgnoreOnTick, u = ["axisLine", "axisLabel", "axisTick", "axisName"], h = "splitLine", c = i(2).extendComponentView({
            ...
            _splitLine: function (t, e) {
                var i = t.axis;
                if (!i.isBlank()) {
                    var n = t.getModel("splitLine"), o = n.getModel("lineStyle"), r = o.get("width"), u = o.get("color"), h = s(n, e);
                    u = u instanceof Array ? u : [u];
        ...
        var h = i(2), c = i(174), d = i(1), f = i(9), p = i(343), g = i(47), m = i(116), v = ["inBrush", "outOfBrush"], y = "__ecBrushSelect", x = "__ecInBrushSelectEvent", _ = h.PRIORITY.VISUAL.BRUSH;
        ...
        t.exports = i(2).extendComponentView({
            type: "radar", render: function (t, e, i) {
                ...
                if (n.length) {
                    var a = t.get("shape"), s = t.getModel("splitLine"), l = t.getModel("splitArea"), u = s.getModel("lineStyle"), h = l.getModel("areaStyle"), c = s.get("show"), d = l.get("show"), f = u.get("color"), p = h.get("color");
        ...
        var s = i(1), l = i(3), u = i(12), h = i(357), c = i(355), d = i(24), f = i(22), p = i(9), g = i(20), m = i(4), v = i(8), y = v.encodeHTML, x = s.bind, _ = s.each, b = Math.PI;
        t.exports = h.extend({
            type: "timeline.slider", init: function (t, e) {
                ...
                g = g * b / 180;
                var m, v, y, x, _ = h.get("position", !0), c = h.get("show", !0), w = c && h.get("showPlayBtn", !0), S = c && h.get("showPrevBtn", !0), M = c && h.get("showNextBtn", !0), I = 0, T = u;
        ...
        var l = i(235), u = i(3), h = i(1), c = i(4), d = i(85), f = i(91), p = i(236), g = i(6), m = c.linearMap, v = h.each, y = Math.min, x = Math.max, _ = 12, b = 6, w = l.extend({
        ...
        var n = i(235), o = i(1), r = i(3), a = i(24), s = i(12), l = i(236), u = n.extend({
            ...
            doRender: function () {
                ...
                var e = this.group;
                e.removeAll();
                var i = this.visualMapModel, n = i.get("textGap"), a = i.textStyleModel, l = a.getFont(), u = a.getTextColor(), h = this._getItemAlign(), c = i.itemSize, d = this._getViewData(), f = d.endsText, p = o.retrieve(i.get("showLabel", !0), !f);
